// Renders CHANGELOG.md (imported raw by main.ts) into the "What's New" modal. The changelog is the
// one place a change is described for the person using the app, so the modal reads it directly
// rather than keeping a second copy that could drift; see the changelog rules in AGENTS.md.
