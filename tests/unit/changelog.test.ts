...
- Added \`thing\` ([#3](https://github.com/brain-bbqs/web-app-template/pull/3))

## 0.0.2

#### 🐛 Bug Fix

- Fixed **something** ([#2](https://github.com/brain-bbqs/web-app-template/pull/2))
...
describe("renderChangelogHtml", () => {
  ...
  it("renders inline code, bold, and links", () => {
    ...
    expect(html).toContain('<a href="https://github.com/brain-bbqs/web-app-template/pull/3"');
  });
